 ...
 *          2.  Open the Utility.java file and set "storageConnectionString", "vaultURL", "AuthClientId", "AuthClientSecret" and optionally "keyVaultKeyID"
 *          3.  Download "Java Cryptography Extension (JCE) Unlimited Strength Jurisdiction Policy Files for your JDK/JRE"
 ...
 *          4.  Extract the jar files and place them in ${java.home}/jre/lib/security/
 *          5.  Set breakpoints and run the project
 */
...
import util.KeyVaultUtility;
import util.LocalResolver;
import util.Utility;
